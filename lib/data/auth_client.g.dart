...
class _AuthClient implements AuthClient {
  ...
  @override
  Future<HttpResponse<dynamic>> tokenLogin(Map<String, dynamic> data) async {
  ...
  Future<User> getUser(String accessToken) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{r'X-Access-Token': accessToken};
  ...
  @override
  Future<HttpResponse<Map<String, String>>> getVersion() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
